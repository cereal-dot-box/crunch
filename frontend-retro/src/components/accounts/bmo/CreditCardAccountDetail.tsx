...
interface CreditCardAccountDetailProps {
  account: Account;
...
export function CreditCardAccountDetail({ account, syncSources = [], onDelete, deletePending, onBack, onAddSyncSource, onEditSyncSource, onRefreshSyncSource, refreshingSyncSourceId, transactions }: CreditCardAccountDetailProps) {
        ...
        <Card>
          ...
          {syncSources.length === 0 ? (
            <div className="text-center py-6">
              ...
              {onAddSyncSource && (
                <Button size="sm" variant="secondary" onClick={onAddSyncSource}>
                  + Add Sync Source
                </Button>
              )}
            </div>
