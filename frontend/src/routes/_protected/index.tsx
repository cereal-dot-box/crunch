  ...
  return (
    <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      <div className="px-4 py-6 sm:px-0">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">{currentMonth}</h1>
        </div>
        ...
        <div className="mb-8">
          <Card>
            <div>
              <p className="text-sm font-medium text-gray-500">Should Save This Month</p>
        ...
        {/* Budget Buckets */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Buckets</h2>
          ...
          <div className="grid grid-cols-1 gap-4 lg:gap-6">
            {budgetStats.buckets.map((bucket) => (
              <Link
                ...
                className="block"
              >
                <Card className="hover:shadow-lg transition-shadow cursor-pointer active:scale-[0.99]">
                  <div className="mb-3">
